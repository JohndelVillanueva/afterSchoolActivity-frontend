// Create a new file: EditSportModal.tsx
        ...
        <div className="border-b border-gray-200 px-8 py-6">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <h3 className="text-2xl font-semibold text-gray-900 mb-1">Edit Sport: {editedSport.name}</h3>
              <p className="text-sm text-gray-600">Update details for this sports activity</p>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                type="datetime-local"
                name="startTime"
                value={formatDateTimeForInput(editedSport.startTime)}
                onChange={handleInputChange}
                className="w-full px-4 py-3 border border-gray-300 focus:outline-none focus:border-gray-900 transition-colors"
                required
              />
            ...
            <div className="space-y-2">
              ...
              <input
                type="datetime-local"
                name="endTime"
                value={formatDateTimeForInput(editedSport.endTime)}
                onChange={handleInputChange}
                className="w-full px-4 py-3 border border-gray-300 focus:outline-none focus:border-gray-900 transition-colors"
                required
              />
            ...
            <div className="flex flex-col md:flex-row gap-4 items-start">
              ...
              >
                {uploading ? (
                  ...
                  <img src={`${API_BASE_URL}${editedSport.photo}`} alt="Sport" className="w-32 h-24 object-cover mb-2 border border-gray-300" />
                ) : (
              ...
              {editedSport.photo && (
                <button
                  ...
                  onClick={() => setEditedSport(prev => ({ ...prev!, photo: '' }))}
                >
                  Remove photo
                </button>
              )}
          ...
          <div className="flex justify-end pt-4 gap-3">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-3 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-colors font-semibold text-base focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
            >
              Cancel
            </button>
            <button
            ...
            >
              {updating ? 'Updating...' : 'Update Sport'}
            </button>
          </div>
        </form>
      </div>
